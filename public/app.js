...
const translations = {
  ru: {
    ...
    errDatabaseUnavailable: "База пользователей на сервере недоступна. Проверьте подключение Supabase в Vercel.",
    errDatabaseMissing: "База пользователей не настроена. Добавьте SUPABASE_DB_URL в Vercel.",
  ...
  en: {
    ...
    errDatabaseUnavailable: "The server user database is unavailable. Check the Supabase connection in Vercel.",
    errDatabaseMissing: "The user database is not configured. Add SUPABASE_DB_URL in Vercel.",
...
const serverMessageKeys = new Map([
  ...
  ["Supabase database is not configured. Set SUPABASE_DB_URL in Vercel.", "errDatabaseMissing"],
...
function chatAvatarSource(chat) {
  if (chat?.id === "yachat-codes") {
    return "/assets/yachat-codes-bot.webp?v=2";
  }
    ...
    return {
      chats: [
        ...
        },
        {
          ...
          canSend: false,
          avatar: "codes",
          avatarDataUrl: "/assets/yachat-codes-bot.webp?v=2",
          createdAt
        },
        {
          id: "yachat-channel",
